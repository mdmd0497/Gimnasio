        ...
        <div class="col align-self-center">
            <form class="form-signin"
                ...
                <div class="input-group mb-3">
                    ...
                    <a id="btn-registro" class="btn btn-primary"
                       href="index.php?pid=<?php echo base64_encode("presentacion/cliente/registro.php"); ?>&action=signup"
                       role="button">Registro Cliente</a>
