...
<div class="container form">
    <div class="row">
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-header bg-primary text-white">Actualizar Foto Entrenador</div>
                <div class="card-body">
                    <?php
                    ...
                    ?>
                    <form action=<?php echo "index.php?pid=" . base64_encode("presentacion/administrador/actualizarFotoEntrenador.php") . "&idEntrenador=" . $_GET["idEntrenador"] ?> method="post"
