...
<div class="container" style="margin-top: 20px;">
    <div class="card" id="inicio-admin">
        <div class="card-header bg-primary text-white">Consultar Entrenadores
...
<div class="modal fade" id="modalEntrenador" role="dialog">
...
<script>
    $(document).ready(function () {
        ...
        $("#formConsulta").keyup(function () {
            ...
            if ($("#formConsulta").val() != "") {
                $("#tabla").show();
                <?php echo "var ruta = \"indexAjax.php?pid=" . base64_encode("presentacion/administrador/filtroEntrenador.php") . "\";";?>
